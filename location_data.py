# 0 means that the user's location is unknown, or they don't live in a city (with cities).
# -1 means that the candidate's location is unknown.
...
auto={0:{2:{3:201}, # Alaska
      ...
      2:{600652:{3:613, # Alameda, CA
         ...
         681204:{3:615, # Union City, CA
                 4:691070},
         1921000:{3:1903}, # Des Moines, IA
         2541960:{4:2541275}, # Milton, MA
